@REM OrcaSlicer build script for Windows with Visual Studio 2026
@echo off
set WP=%CD%
...
echo on
set CMAKE_POLICY_VERSION_MINIMUM=3.5
cmake .. -G "Visual Studio 18 2026" -A x64 -DORCA_TOOLS=ON %SIG_FLAG% -DCMAKE_BUILD_TYPE=%build_type%
