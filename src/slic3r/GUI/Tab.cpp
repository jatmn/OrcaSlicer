...
void TabPrinter::build_unregular_pages(bool from_initial_build/* = false*/)
{
    ...
    bool		is_marlin_flavor = (flavor == gcfMarlinLegacy || flavor == gcfMarlinFirmware || flavor == gcfKlipper || flavor == gcfRepRapFirmware || flavor == gcfRepetier || flavor == gcfCheetah);
...
void TabPrinter::toggle_options()
{
    ...
    if (m_active_page->title() == L("Motion ability")) {
        ...
        for (int i = 0; i < max_field; ++i)
            toggle_option("machine_max_acceleration_travel", gcf != gcfMarlinLegacy && gcf != gcfKlipper && gcf != gcfCheetah, i);
        toggle_line("machine_max_acceleration_travel", gcf != gcfMarlinLegacy && gcf != gcfKlipper && gcf != gcfCheetah);
        for (int i = 0; i < max_field; ++i)
        ...
        bool input_shaping_compatible = gcf == GCodeFlavor::gcfMarlinFirmware || gcf == GCodeFlavor::gcfRepRapFirmware;
        ...
        if (input_shaping_compatible) {
            ...
            bool reprap = gcf == GCodeFlavor::gcfRepRapFirmware;
